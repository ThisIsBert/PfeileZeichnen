 ...
 * @property {number} shaftThicknessFactor
 * @property {number} arrowHeadLengthFactor
 * @property {number} arrowHeadWidthFactor
 ...
 * @property {(value: number) => void} onShaftThicknessChange
 * @property {(value: number) => void} onArrowHeadLengthChange
 * @property {(value: number) => void} onArrowHeadWidthChange
...
const ControlPanel = ({ uiState, actions }) => {
    const { editingState, canCopyArrow, canDeleteArrow, shaftThicknessFactor, arrowHeadLengthFactor, arrowHeadWidthFactor, canEditParameters, arrowName, canEditName, canCopyGeoJson, canSaveAllGeoJson } = uiState;
    const { onDrawArrow, onCopyArrow, onDeleteArrow, onShaftThicknessChange, onArrowHeadLengthChange, onArrowHeadWidthChange, onArrowNameChange, onCopyGeoJson, onSaveAllGeoJson, onConfirm, onCancel } = actions;
    ...
    return (_jsxs("div", { id: "controlPanel", className: "absolute top-4 right-4 z-[10000] bg-white p-4 border border-gray-300 rounded-lg shadow-lg w-64 flex flex-col gap-3", children: [_jsx("button", { id: "drawArrowBtn", title: "Neuen Pfeil zeichnen", onClick: onDrawArrow, disabled: isEditingOrDrawing, className: `${commonButtonClass} w-full
                    ...
                    disabled:bg-blue-200 disabled:text-blue-500 disabled:cursor-not-allowed`, children: "Neuen Pfeil zeichnen" }), _jsxs("div", { className: "flex gap-2", children: [_jsx("button", { id: "copyArrowBtn", title: "Aktuell bearbeiteten Pfeil kopieren", onClick: onCopyArrow, disabled: !canCopyArrow, className: `${commonButtonClass} flex-1 text-slate-700
                      ...
                      disabled:bg-red-200 disabled:text-red-500 disabled:cursor-not-allowed`, children: "Pfeil Löschen" })] }), _jsxs("div", { children: [_jsxs("label", { htmlFor: "shaftThicknessSlider", className: "block text-sm font-medium text-gray-700 mb-1", children: ["Schaftdicke: ", shaftThicknessFactor.toFixed(3)] }), _jsx("input", { type: "range", id: "shaftThicknessSlider", min: "0.005", max: "0.1", step: "0.005", value: shaftThicknessFactor, onChange: (e) => onShaftThicknessChange(parseFloat(e.target.value)), disabled: !canEditParameters, className: "w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed" })] }), _jsxs("div", { children: [_jsxs("label", { htmlFor: "arrowHeadLengthSlider", className: "block text-sm font-medium text-gray-700 mb-1", children: ["Pfeilspitzenlänge: ", arrowHeadLengthFactor.toFixed(3)] }), _jsx("input", { type: "range", id: "arrowHeadLengthSlider", min: "0.05", max: "0.2", step: "0.01", value: arrowHeadLengthFactor, onChange: (e) => onArrowHeadLengthChange(parseFloat(e.target.value)), disabled: !canEditParameters, className: "w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed" })] }), _jsxs("div", { children: [_jsxs("label", { htmlFor: "arrowHeadWidthSlider", className: "block text-sm font-medium text-gray-700 mb-1", children: ["Pfeilspitzenbreite: ", arrowHeadWidthFactor.toFixed(3)] }), _jsx("input", { type: "range", id: "arrowHeadWidthSlider", min: "0.05", max: "0.2", step: "0.01", value: arrowHeadWidthFactor, onChange: (e) => onArrowHeadWidthChange(parseFloat(e.target.value)), disabled: !canEditParameters, className: "w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed" })] }), _jsxs("div", { className: "mt-2 border-t border-gray-200 pt-3 flex flex-col gap-2", children: [_jsx("label", { htmlFor: "arrowNameInput", className: "block text-sm font-medium text-gray-700", children: "Pfeil Name (aktuell):" }), _jsx("input", { type: "text", id: "arrowNameInput", placeholder: "Name für GeoJSON", value: arrowName, onChange: (e) => onArrowNameChange(e.target.value), disabled: !canEditName, className: "w-full px-2 py-1 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 disabled:opacity-50 disabled:bg-gray-50" }), _jsx("button", { id: "copyGeoJsonBtn", title: "Aktuellen Pfeil-Umriss als GeoJSON kopieren", onClick: onCopyGeoJson, disabled: !canCopyGeoJson, className: `${commonButtonClass} w-full mt-1 text-slate-700
