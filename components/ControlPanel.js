...
const ControlPanel = ({ uiState, actions }) => {
    const { editingState, canCopyArrow, canDeleteArrow, arrowName, canEditName, canCopyGeoJson, canSaveAllGeoJson } = uiState;
    const { onDrawArrow, onCopyArrow, onDeleteArrow, onArrowNameChange, onCopyGeoJson, onSaveAllGeoJson, onConfirm, onCancel } = actions;
