...
export default function ControlPanel({
  ...
  return (
    <div
      id="controlPanel"
      className="absolute top-4 right-4 z-[10000] bg-white p-4 border border-gray-300 rounded-lg shadow-lg w-64 flex flex-col gap-3"
    >
      <button
        id="drawArrowBtn"
        ...
        className={`${commonButtonClass} w-full bg-blue-500 text-white hover:bg-blue-600 disabled:bg-blue-200 disabled:text-blue-500 disabled:cursor-not-allowed`}
      >
      ...
      <div className="flex gap-2">
        <button
          ...
          className={`${commonButtonClass} flex-1 text-slate-700 disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed`}
        >
          Kopieren
        </button>
        <button
          ...
          className={`${commonButtonClass} flex-1 bg-red-500 text-white hover:bg-red-600 disabled:bg-red-200 disabled:text-red-500 disabled:cursor-not-allowed`}
        >
          Pfeil Löschen
        </button>
      </div>
      ...
      <div className="mt-2 border-t border-gray-200 pt-3 flex flex-col gap-2">
        ...
        <button
          ...
          className={`${commonButtonClass} w-full mt-1 text-slate-700 disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed`}
        >
          GeoJSON kopieren
        </button>
        <button
          ...
          className={`${commonButtonClass} w-full mt-1 bg-green-500 text-white hover:bg-green-600 disabled:bg-green-200 disabled:text-green-500 disabled:cursor-not-allowed`}
        >
